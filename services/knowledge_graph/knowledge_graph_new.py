...
class KnowledgeGraph(object):
    def __init__(self):
        self.context_label = {"labelV": "contextId"}
        self.instance_label = {"labelV": "instanceId"}
        self.context_instance_rel = {"labelE": "hasMeeting"}

        self.instance_segment_rel = {"labelE": "hasSegment"}

        self.user_label = {"attribute": "authorId"}
        self.transcriber_label = {"attribute": "segmentProvider"}

        self.segment_user_rel = {"labelE": "authoredBy"}
        self.segment_transcriber_rel = {"labelE": "providedBy"}

        self.recording_label = {"attribute": "sourceId", "type": "recording"}
        self.segment_recording_rel = {"labelE": "hasSource"}

        self.keyphrase_label = {"attribute": "importantKeywords"}
        self.segment_keyphrase_rel = {"labelE": "hasKeywords"}

        self.mind_label = {"attribute": "mindId"}
        self.context_mind_rel = {"labelE": "associatedMind"}
    ...
    def populate_word_graph_info(self, request, context_graph, word_graph):
        ...
        context_graph.add_edge(instance_id, word_graph, labelE="hasWordGraph")

        return context_graph

    def query_word_graph_object(self, context_graph):
        for (n1, n2, e_attr) in context_graph.edges.data("labelE"):
